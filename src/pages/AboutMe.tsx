...
const AboutMe = ({
  ...
  return (
    <section
      ref={sectionRef}
      className="full-height-fix w-screen relative flex justify-center bg-black snap-center overflow-clip"
    >
      {/* <div className="absolute w-full h-1/3 -bottom-10 translate-y-1/2 flex flex-col">
        <motion.div
          className=" w-full h-2/5 bg-gradient-to-t from-blue-950 to-black"
          initial={{ opacity: 0.6 }}
        ...
        ></motion.div>
        <motion.div
          className=" w-full h-2/5 bg-gradient-to-b from-blue-950 to-black z-30"
          initial={{ opacity: 0.6 }}
          // animate={{ opacity: sectionVisible ? 0.6 : 0 }}
          transition={{
            duration: 1,
