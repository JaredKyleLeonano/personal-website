...
const Works = ({
  ...
  return (
    <section
      ref={sectionRef}
      className="flex justify-center items-center h-dvh w-screen relative [background:radial-gradient(ellipse_250%_100%_at_50%_50%,#0B2F2F_0%,black_60%)] snap-center"
    >
