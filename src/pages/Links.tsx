...
const Links = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex h-full flex-col w-full items-center justify-center  px-4 pt-12 gap-8 md:px-64 md:gap-16">
        <div className="text-[#d1d5dc] font-Zrnic text-4xl md:text-7xl">
          Find Me Online
        </div>
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-8">
          {linkDetails.map((link, index) => (
            <a
              ...
              key={index}
              className={`rounded flex-1 border-2 bg-gray-900/30 border-[#364153] group hover:border-[#6a7282] hover:shadow-[0_0_25px_#6a7282] transition-all duration-300 p-4 md:p-6`}
            >
              <div className="flex flex-col items-center gap-1">
                <div className="rounded flex justify-center items-center border-2 bg-[#1f2a3b] border-[#364153] group-hover:border-[#6a7282] duration-300 p-2">
                  <FontAwesomeIcon
                    className="text-[#99a1af] bg-gray-800 group-hover:text-[#d1d5dc] transition-colors duration-300 text-lg md:text-3xl"
                    icon={link.icon}
                  ></FontAwesomeIcon>
                </div>
                <div className="flex flex-col items-center text-white">
                  <p className="font-Exo2 font-light text-[#444e5d] text-xs md:text-base">
                    {link.name}
                  </p>
                  <p className="font-Exo2 break-words text-center text-[#99a1af] group-hover:text-[#d1d5dc] transition-colors duration-300 text-xs md:text-base">
                    {link.description}
                  </p>
                </div>
              </div>
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          <p className="text-[#4a5565] font-Exo2 text-xs md:text-base">
            © 2025 LEONANO
          </p>
        </div>
      </div>
