...
const ContactMe = ({
  ...
  return (
    <section
      ref={sectionRef}
      className="flex justify-center items-center h-[100dvh] w-screen relative [background:radial-gradient(ellipse_100%_130%_at_2%_53%,#B37800_0%,black_40%)] snap-center"
    >
      <div
        ref={globeRef}
